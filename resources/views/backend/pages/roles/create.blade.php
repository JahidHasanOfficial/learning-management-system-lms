            ...
            <div class="padding_infor_info">
                ...
                <form action="{{ route('role.store') }}" method="POST">
                    ...
                    <div class="form-group mb-4">
                        ...
                        <input type="text" name="name" id="name" class="form-control" placeholder="Enter Role Name" required value="{{ old('name') }}">
                    </div>
                            ...
                            <div class="col-md-4 mb-4">
                                <div class="card bg-light border-0">
                                    ...
                                    <div class="card-body p-3">
                                        ...
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" name="permissions[]" value="{{ $perm->name }}" class="custom-control-input permission-checkbox" id="perm_{{ $perm->id }}">
                    ...
                    <div class="form-group text-right">
                        ...
                        <button type="submit" class="btn btn-success px-5">Save Role</button>
                    </div>
                </form>
            </div>
        </div>
